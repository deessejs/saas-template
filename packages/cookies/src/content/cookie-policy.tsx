...
export function CookiePolicy() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-16">
      <H1>Cookie Policy</H1>
      <P>
        This page explains what cookies are, what we use them for, and your
        choices.
      </P>
      ...
      <P>
        ...
        traffic. All cookies are opt-in — we never set non-essential cookies
      ...
      <P>
        These cookies are required for the website to function properly. They
        cannot be disabled. Examples: session cookies for authentication,
        security cookies.
      </P>
      ...
      <P>
        ...
        by collecting anonymous information. We use this data to improve our
        content and user experience. Examples: Google Analytics, page view
        tracking.
      </P>

      <H3>Marketing</H3>
      <P>
        These cookies are used to deliver personalized advertisements. They
        track browsing behavior across websites to show relevant ads. Examples:
