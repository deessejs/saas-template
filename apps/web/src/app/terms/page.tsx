...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-16">
      ...
      <P>
        By using this application, you agree to these terms. Replace this page
        with your actual terms of service before going to production.
      </P>
      <H2>Acceptance of Terms</H2>
      <P>
        By accessing or using the service, you agree to be bound by these Terms
        of Service and to comply with all applicable laws and regulations.
      </P>
